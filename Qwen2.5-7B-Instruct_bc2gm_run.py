...
args = TrainingArguments(
    output_dir="output/Qwen2.5-7B-Instruct_bc2gm_model",
...
swanlab_callback = SwanLabCallback(
    ...
    experiment_name="Qwen2.5-7B-Instruct_bc2gm_data",
    description="使用Qwen2.5-7B-Instruct模型在bc2gm_data数据集上微调，实现关键实体识别任务。",
    config={
        "model": model_id,
        "model_dir": model_dir,
        "dataset": "_bc2gm_data",
